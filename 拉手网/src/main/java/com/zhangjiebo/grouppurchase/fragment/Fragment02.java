...
import com.zhangjiebo.grouppurchase.MapActivity;
...
public class Fragment02 extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (mInflate==null){
            ...
            mPull_refresh_list = (PullToRefreshListView) mInflate.findViewById(R.id.pull_refresh_list02);

            mBaide_map = (ImageView) mInflate.findViewById(R.id.baide_map);
