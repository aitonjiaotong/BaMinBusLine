package com.example.administrator.busline_aition_utils;
...
public class MyConstants
{
    public class Str
    {
        public static final String mTv_curr_loction = "我的位置";
        public static final String mTv_ending_station = "输入终点";
    }
